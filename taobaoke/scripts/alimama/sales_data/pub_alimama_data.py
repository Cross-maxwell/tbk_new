...
def push_data():
    ...
    for i in range(1, nrows):
        ...
        tmp_orderlist += ['98188871442438090', '99938914993063108', '94398810214883174', '99930540669909042', '94404831691893574',
                          ...
                          '114932576142937620', '115014898373937620']
        ...
        # and unindent below block  --------------------    下面的if条件中， 最后一个判断时间的条件，到2018.01.23删除！
            if (float(result_dict['commision_rate'][:-2])/100.0 < 0.05) and tmp_condition and (datetime(2017, 12, 19) < create_time < datetime(2017, 12, 27,06,25,00)) :
